сборка проекта и запуск FileTransmitter
...
5. переходим в директорию FileTransmitter
6. для сборки проекта с помошью maven пишем: mvn compile
7. запускаем FileTransmitter: mvn exec:java -Dexec.mainClass="FileTransmitter.ServerStarter"
...
2. Файл появится в target/FileTransmitter-......-jar-with-dependencies.jar (прим. настройки плагина 'maven-assembly-plugin' в pom.xml)
3. Файл можно переместить в любую папку (назовем ее "progFolder")
4. В папке с файлом (progFolder) должен находится файл настроек filetransmitter.conf.xml
6. Запуск .jar на JVM: java -jar FileTransmitter-..(версия)..-jar-with-dependencies.jar

===============================================================================================================
Конфигурационный файл: xmlwfiletransmitterorker.conf.xml
